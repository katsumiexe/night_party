...
if($del > 0){//■削除
	$sql="DELETE FROM ".TABLE_KEY."_cast_log WHERE log_id='{$del}'";
...
if($item_name){
	$sql_log ="INSERT INTO ".TABLE_KEY."_cast_log_list(`master_id`,`log_color`,`log_icon`,`log_comm`,`log_price`,`del`) VALUES ";
