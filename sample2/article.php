...
$sql ="SELECT view_date, title, log, img, img_del, cast, genji,tag_name,tag_icon, C.prm AS c_prm, P.prm AS p_prm  FROM ".TABLE_KEY."_posts AS P";
...
$sql.=" AND (C.cast_status<4 OR C.cast_status IS NULL)";
...
$sql ="SELECT P.id, view_date, title, img, img_del, cast, genji,tag_name,tag_icon, C.prm AS c_prm, P.prm AS p_prm FROM ".TABLE_KEY."_posts AS P";
$sql.=" LEFT JOIN ".TABLE_KEY."_cast AS C ON P.cast=C.id";
$sql.=" LEFT JOIN ".TABLE_KEY."_tag AS T ON P.tag=T.id";
$sql.=" WHERE P.status=0";
