...
$sql	 ="SELECT  P.id, P.view_date,  P.title, P.log, P.tag, P.img, P.img_del, P.status, P.prm, COUNT(L.days) AS cnt FROM ".TABLE_KEY."_posts AS P ";
$sql	 .=" LEFT JOIN (SELECT `days`,`ip`,`ua`,page,value FROM ".TABLE_KEY."_log WHERE page='article.php' GROUP BY value, days,ip,ua) AS L ON P.id=L.value ";
