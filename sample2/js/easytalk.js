...
//				console.log(data);
	...
	$('.ck0').on('change',function(){	
		$.post({
			...
			$('.easytalk_sub_opt_chg').fadeIn(200).delay(2000).fadeOut(600);
	...
	$('.easytalk_sub_opt_title').on('click',function(){	
		if($('.easytalk_sub_opt').css('display') === 'none'){
			$('.easytalk_sub_opt').slideDown(1000);
		}else{
			$('.easytalk_sub_opt').slideUp(1000);
		}
	});
