...
　<input id="sel_cast" value="2" type="radio" name="c_s" checked="checked"><label id="cast_l" for="sel_cast" class="c_s_btn on_2">CAST</label>
</div>
</header>
<div class="wrap">
<div class="main_box">
...
<td>
	<div>名前			</div><input type="text" name="staff_name1" class="w000" autocomplete="off">
</td><td>
