...
$c_id		=$_POST["c_id"];
$sql	 ="SELECT * FROM ".TABLE_KEY."_cast_log";
...
if($result = mysqli_query($mysqli,$sql)){
	while($dat1 = mysqli_fetch_assoc($result)){
		...
		$dat.="<div class=\"customer_memo_date\"><span class=\"customer_detail_in\"></span><span class=\"customer_log_icon\"></span><span class=\"customer_log_date_detail\">{$t_date} {$s_time}-{$e_time}</span>";
		...
		$dat.="<div class=\"customer_log_memo customer_detail_in\">";
		$dat.="{$dat1["log"]}";
		$dat.="</div>";
