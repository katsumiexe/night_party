...
$sql1	 ="INSERT INTO wp00000_easytalk";
$sql1	.="(send_date,customer_id,cast_id,send_flg,log,img,`mail_del`)";
$sql1	.="VALUES";

$sql2	 ="INSERT INTO wp00000_ssid";
...
$sql	 ="SELECT M.customer_id, C.name, C.nickname, C.block, C.face, C.mail, MAX(send_date) AS l_date, MAX(mail_id) AS m_id FROM wp00000_easytalk AS M";
