...
$sql ="SELECT view_date, title, log, img, img_del, cast, genji,tag_name,tag_icon, C.prm AS c_prm, P.prm AS p_prm  FROM wp00000_posts AS P";
...
$sql ="SELECT P.id, view_date, title, img, img_del, cast, genji,tag_name,tag_icon, C.prm AS c_prm, P.prm AS p_prm FROM wp00000_posts AS P";
$sql.=" LEFT JOIN wp00000_cast AS C ON P.cast=C.id";
$sql.=" LEFT JOIN wp00000_tag AS T ON P.tag=T.id";
$sql.=" WHERE P.status=0";
$sql.=" AND C.cast_status<4";
